...
<div class="content">
    ...
    <?php
        ...
        {
            echo '<p class="open">*Pendaftaran sukses. Mohon login pada menu login di kanan</p>';
        }
    ?>
    <form action="includes/signup.inc.php" method='post' id="contact-form" enctype="multipart/form-data">
        ...
        <br>
        <h5>Gender</h5>
        <label class="container" for="gender-m">Laki-laki
          <input type="radio" checked="checked" name="gender" value="m" id="gender-m">
          <span class="checkmark"></span>
        </label>
        <label class="container" for="gender-f">Perempuan
    ...
    <br><br>
        ...
        <input type="submit" class="button next" name="signup-submit" value="Daftar">
