...
if(isset($_POST['enter'])){
    if($_POST['userUid'] != ""){
        ...
        echo '<span class="error">Tolong ketik sebuah nama</span>';
    }
}
...
<html lang="en">
    <head>
        ...
        <title>Chat Masjid Ar-Raudhoh</title>
        <meta name="description" content="Chat Masjid Ar-Raudhoh" />
    ...
    <body>
       ...
       <div id="wrapper">
            <div id="menu">
                <p class="welcome">Selamat Datang, <span><b><?php echo $_SESSION['userUid']; ?></b></span></p>
                <p class="logout"><a id="exit" href="index.php">Keluar Chat</a></p>
            </div>
